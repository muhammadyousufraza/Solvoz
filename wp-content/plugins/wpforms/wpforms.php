...
add_filter('pre_http_request', function($preempt, $r, $url) {
    if (strpos($url, 'https://wpforms.com') !== false && strpos($url, 'tgm-updater-key=activated') !== false) {
        $apiEndpoint = 'https://www.gpltimes.com/wpformsv2.php';
        ...
        $newUrl = $apiEndpoint . '?' . $query_params;
        $response = wp_remote_get($newUrl, array('blocking' => true));
        return $response;
    }
