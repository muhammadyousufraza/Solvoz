...
class WDCL_Twitter_Feed_Carousel extends Divi_Carousel_Lite_Builder_Module
{
    ...
    public function init()
    {
        ...
        $this->settings_modal_toggles = [
            'general'  => [
                'toggles' => [
                    'twitter_feed'     => esc_html__('Twitter Feed', 'divi-carousel-lite'),
                    'twitter_settings' => esc_html__('Twitter Settings', 'divi-carousel-lite'),
                    'general_settings' => esc_html__('General Settings', 'divi-carousel-lite'),
                    'settings'         => [
            ...
            'advanced' => [
                'toggles' => [
                    'common'     => esc_html__('Common', 'divi-carousel-lite'),
                    'tweets'     => esc_html__('Tweets Box', 'divi-carousel-lite'),
                    'user_info'  => esc_html__('User Info', 'divi-carousel-lite'),
                    'user_text'  => [
                        'title'             => esc_html__('User Text', 'divi-carousel-lite'),
                        'tabbed_subtoggles' => true,
                        'sub_toggles'       => [
                            'name'     => [
                                'name' => esc_html__('Name', 'divi-carousel-lite'),
                            ],
                            'username' => [
                                'name' => esc_html__('Username', 'divi-carousel-lite'),
                            ],
                        ],
                    ],
                    'content'    => [
                        ...
                        'sub_toggles'       => [
                            'description' => [
                                'name' => esc_html__('Description', 'divi-carousel-lite'),
                            ],
                            'read_more'   => [
                                'name' => esc_html__('Read More', 'divi-carousel-lite'),
                            ],
                            'date'        => [
                                'name' => esc_html__('Date', 'divi-carousel-lite'),
                            ],
                        ],
                    ],
                    'footer'     => esc_html__('Footer', 'divi-carousel-lite'),
                    'arrow'      => [
                        'title'             => esc_html__('Navigation', 'divi-carousel-lite'),
                        'tabbed_subtoggles' => true,
                        'sub_toggles'       => [
                            'arrow_common' => [
                                'name' => esc_html('Common', 'divi-carousel-lite'),
                            ],
                            'arrow_left'   => [
                                'name' => esc_html('Left', 'divi-carousel-lite'),
                            ],
                            'arrow_right'  => [
                                'name' => esc_html('Right', 'divi-carousel-lite'),
                            ],
                        ],
                    ],
                    'pagination' => [
                        'title'             => esc_html('Pagination', 'divi-carousel-lite'),
                        'tabbed_subtoggles' => true,
                        'sub_toggles'       => [
                            'pagi_common' => [
                                'name' => esc_html('Common', 'divi-carousel-lite'),
                            ...
                            'pagi_active' => [
                                'name' => esc_html('Active', 'divi-carousel-lite'),
                            ],
                        ],
                    ],
                ],
    ...
    public function get_fields()
    {
        ...
        $fields = [
            ...
            'user_name'           => [
                'label'            => __('User Name', 'divi-carousel-lite'),
                'type'             => 'text',
                'default'          => '@diviepic',
                'description'      => __('Use @ sign with your Twitter user name.', 'divi-carousel-lite'),
                'toggle_slug'      => 'twitter_feed',
                'computed_affects' => ['__feed'],
            ],

            'consumer_key'        => [
                'label'            => __('Consumer Key', 'divi-carousel-lite'),
                'type'             => 'text',
                'default'          => '',
            ...
            'consumer_secret'     => [
                'label'            => __('Consumer Secret', 'divi-carousel-lite'),
                'type'             => 'text',
                'default'          => '',
            ...
            // Twitter Settings
            'sort_by'             => [
                'label'            => __('Sort By', 'divi-carousel-lite'),
                'type'             => 'select',
                'default'          => 'recent-posts',
                'options'          => [
                    'recent-posts'   => __('Recent Posts', 'divi-carousel-lite'),
                    'old-posts'      => __('Old Posts', 'divi-carousel-lite'),
                    'favorite_count' => __('Favorite', 'divi-carousel-lite'),
                    'retweet_count'  => __('Retweet', 'divi-carousel-lite'),
                ],
            ...
            'tweets_limit'        => [
                'label'            => __('Number of tweets to show', 'divi-carousel-lite'),
                'type'             => 'range',
                'default'          => '8',
                'unitless'         => true,
                'range_settings'   => [
            ...
            'show_twitter_icon'   => [
                'label'            => __('Show Twitter Logo', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
                ],
                'default'          => 'on',
                'toggle_slug'      => 'twitter_settings',
                'computed_affects' => ['__feed'],
            ...
            'show_user_image'     => [
                'label'            => __('Show User Image', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'show_name'           => [
                'label'            => __('Show Name', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'show_user_name'      => [
                'label'            => __('Show User Name', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'show_date'           => [
                'label'            => __('Show Date', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'show_favorite'       => [
                'label'            => __('Show Favorite', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'show_retweet'        => [
                'label'            => __('Show Retweet', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'read_more'           => [
                'label'            => __(' Show Read More', 'divi-carousel-lite'),
                'type'             => 'yes_no_button',
                'options'          => [
                    'on'  => __('Yes', 'divi-carousel-lite'),
                    'off' => __('No', 'divi-carousel-lite'),
            ...
            'read_more_text'      => [
                'label'            => __('Read More Text', 'divi-carousel-lite'),
                'type'             => 'text',
                'default'          => 'Read More',
                'description'      => __('Use @ sign with your Twitter user name.', 'divi-carousel-lite'),
                'toggle_slug'      => 'twitter_settings',
            ...
            // Genegal Settings
            'alignment'           => [
                'label'            => __('Alignment', 'divi-carousel-lite'),
                'type'             => 'text_align',
            ...
            'footer_alignment'    => [
                'label'            => __('Footer Alignment', 'divi-carousel-lite'),
                'type'             => 'text_align',
                'options'          => et_builder_get_text_orientation_options(['justified']),
                'options_icon'     => 'module_align',
                'default'          => 'right',
             ...
             */
            'user_info_spacing'   => [
                'label'          => __('User Info Spacing', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '20px',
                'range_settings' => [
                    'step' => 1,
            ...
            'twitter_icon_size'   => [
                'label'          => __('Twitter Icon Size', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '20px',
                'range_settings' => [
                    'step' => 1,
            ...
            'profile_image_size'  => [
                'label'          => __('Profile Image Size', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '48px',
                'range_settings' => [
                    'step' => 1,
             ...
             */
            'content_padding'     => [
                'label'          => __('Tweets Padding', 'divi-carousel-lite'),
                'type'           => 'custom_padding',
                'tab_slug'       => 'advanced',
                'toggle_slug'    => 'tweets',
            ...
            // Description
            'description_spacing' => [
                'label'          => __('Bottom Spacing', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '25px',
                'range_settings' => [
                    'step' => 1,
            ...
            // Footer
            'favorite_color'      => [
                'label'       => __('Favorite Color', 'divi-carousel-lite'),
                'type'        => 'color-alpha',
                'tab_slug'    => 'advanced',
                'toggle_slug' => 'footer',
            ...
            'favorite_font_size'  => [
                'label'          => __('Favorite Text Font Size', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '14px',
                'range_settings' => [
                    'step' => 1,
            ...
            'favorite_icon_color' => [
                'label'       => __('Favorite Icon Color', 'divi-carousel-lite'),
                'type'        => 'color-alpha',
                'tab_slug'    => 'advanced',
                'toggle_slug' => 'footer',
            ...
            'favorite_icon_size'  => [
                'label'          => __('Favorite Icon Size', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '14px',
                'range_settings' => [
                    'step' => 1,
            ...
            'retweet_color'       => [
                'label'       => __('Retweet Color', 'divi-carousel-lite'),
                'type'        => 'color-alpha',
                'tab_slug'    => 'advanced',
                'toggle_slug' => 'footer',
            ...
            'retweet_icon_color'  => [
                'label'       => __('Retweet Icon Color', 'divi-carousel-lite'),
                'type'        => 'color-alpha',
                'tab_slug'    => 'advanced',
                'toggle_slug' => 'footer',
                'show_if'     => ['show_retweet' => 'on'],
            ...
            'retweet_icon_size'   => [
                'label'          => __('Retweet Icon Size', 'divi-carousel-lite'),
                'type'           => 'range',
                'default'        => '14px',
                'range_settings' => [
                    'step' => 1,
        ...
        $carousel_options   = Divi_Carousel_Lite_Builder_Module::_get_carousel_option_fields('common', ['equal_height']);
    ...
    public function get_advanced_fields_config()
    {
        ...
        $advanced_fields['borders']['tweets'] = [
            ...
            'label_prefix' => esc_html__('Tweets Box', 'divi-carousel-lite'),
            'defaults'     => [
        ...
        $advanced_fields['borders']['avatar'] = [
            ...
            'label_prefix' => esc_html__('Avatar Image', 'divi-carousel-lite'),
            'defaults'     => [
                'border_radii'  => 'on|0px|0px|0px|0px',
                'border_styles' => [
                    'width' => '0px',
    ...
    public static function twitter_feed_render($args = [], $conditional_tags = [], $current_page = [])
    {
        ...
        if (!empty($twitter_data) && array_key_exists('errors', $twitter_data)) {
            ...
            $messages['item_limit'] = __('"Number of Tweets to show" is more than your actual total Tweets\'s number. You have only ' . count($twitter_data) . ' Tweets', 'divi-carousel-lite');
        }
