...
class DIFL_FAQ extends ET_Builder_Module
{
    ...
    public function init()
    {
        ...
        $this->icon_path        =  DIFL_ADMIN_DIR_PATH . 'dashboard/static/module-icons/faq.svg';
    }
    ...
    public function get_settings_modal_toggles()
    {
        ...
        return [
            'general'   => array(
                'toggles'       => array(
                    'setting'   => esc_html__('General Settings', 'divi_flash'),
    ...
    public function get_fields()
    {
        ...
        $faq_animation = [
            'faq_animation'  => array(
                'label'      => esc_html__('Animation Type', 'divi_flash'),
                'type'       => 'select',
                'default'    => 'slide',
                'options'    => array(
            ...
            'content_anime_duration'          => array(
                'label'             => esc_html__('Answer Animation Duration (ms)', 'divi_flash'),
                'type'              => 'range',
                'toggle_slug'       => 'animation',
                'default'           => '250',
                'default_unit'      => '',
        ...
        $ans_btn_margin = $this->add_margin_padding(
            array(
                ...
                'tab_slug'      => 'advanced',
                'default_padding' => '5px|5px|5px|5px',
                'default_margin' => '5px|0px|5px|0px'
            )
        );
    ...
    public function get_advanced_fields_config()
    {
        ...
        $advanced_fields['fonts'] = [
            'question_text'         => array(
                ...
                'css'       => array(
                    'main'  => "$this->main_css_element .df_faq_item .faq_question_wrapper .faq_question_title",
                    'hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_question_title",
                    'important' => 'all'
                )
            ),
            ...
            'active_design_question_text'  => array(
                ...
                'css'       => array(
                    'main'  => "$this->main_css_element .df_faq_item.active .faq_question_wrapper .faq_question_title",
                    'hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_question_title",
                    'important' => 'all'
                )
            ),
            ...
            'design_answer_text' => array(
                ...
                'css'       => array(
                    'main'  => "$this->main_css_element .faq_answer_wrapper .faq_answer, $this->main_css_element .faq_answer_wrapper .faq_answer p",
                    'hover' => "$this->main_css_element .faq_answer_wrapper .faq_answer:hover, $this->main_css_element .faq_answer_wrapper .faq_answer:hover p",
                    'important' => 'all'
                ),
                // answer design
                'block_elements' => array(
                    ...
                    'css'  => array(
                        ...
                        'hover' => "$this->main_css_element .faq_answer_wrapper .faq_answer:hover p",
                        'a' => "$this->main_css_element .faq_answer_wrapper .faq_answer a",
                        'ul' => "$this->main_css_element .faq_answer_wrapper .faq_answer ul",
                        'ol' => "$this->main_css_element .faq_answer_wrapper .faq_answer ol",
                        'quote' => "$this->main_css_element .faq_answer_wrapper .faq_answer blockquote",
                    )
                )
            ),
            'ans_button'       => array(
                ...
                'css'       => array(
                    'main'  => "$this->main_css_element .faq_answer_wrapper .faq_answer_area .faq_answer .faq_button a",
                    'hover' => "$this->main_css_element .faq_answer_wrapper .faq_answer_area .faq_answer .faq_button:hover a",
                    'important' => 'all'
                )
            ),
        ...
        $advanced_fields['borders'] = array(
            ...
            'que_wrapper_border' => array(
                'css'            => array(
                    'main'  => array(
                        'border_radii'       => "$this->main_css_element .df_faq_item .faq_question_wrapper",
                        'border_radii_hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover",
                        'border_styles'      => "$this->main_css_element .df_faq_item .faq_question_wrapper",
                        'border_styles_hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover",
                    )
                ),
                'toggle_slug'     => 'design_question',
                'tab_slug'        => 'advanced'
            ...
            'que_img_border' => array(
                'css' => array(
                    'main' => array(
                        ...
                        'border_radii_hover' => "$this->main_css_element .faq_question_wrapper:hover .faq_question_image",
                        'border_styles'      => "$this->main_css_element .faq_question_image",
                        'border_styles_hover' => "$this->main_css_element .faq_question_wrapper:hover .faq_question_image",
                    )
                ),
                'toggle_slug'     => 'design_que_img',
                'sub_toggle'      => 'close',
            ...
            'active_que_img_border' => array(
                'css' => array(
                    'main' => array(
                        'border_radii'       => "$this->main_css_element .df_faq_item.active .faq_question_image",
                        'border_radii_hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_question_image",
                        'border_styles'      => "$this->main_css_element .df_faq_item.active .faq_question_image",
                        'border_styles_hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_question_image",
                    )
                ),
                'toggle_slug'     => 'design_que_img',
                'sub_toggle'      => 'open',
            ...
            'que_icon_wrapper_border' => array(
                'css' => array(
                    'main' => array(
                        'border_radii'       => "$this->main_css_element .df_faq_item .faq_icon",
                        'border_radii_hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_icon",
                        'border_styles'      => "$this->main_css_element .df_faq_item .faq_icon",
                        'border_styles_hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_icon",
                    )
                ),
                'toggle_slug'     => 'design_faq_icon',
                'sub_toggle'      => 'close',
                'tab_slug'        => 'advanced',
                'depends_on'      => array('disable_faq_icon'),
                'depends_show_if' => 'off'
            ),
            'active_que_icon_wrapper_border' => array(
                'css' => array(
                    'main' => array(
                        ...
                        'border_radii_hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_icon",
                        'border_styles'      => "$this->main_css_element .df_faq_item.active .faq_icon",
                        'border_styles_hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_icon",
                    )
                ),
                'toggle_slug'     => 'design_faq_icon',
                'sub_toggle'      => 'open',
            ...
            'ans_img_border' => array(
                'css' => array(
                    'main' => array(
                        'border_radii'       => "$this->main_css_element .faq_answer_image",
                        'border_radii_hover' => "$this->main_css_element .faq_answer_image:hover",
                        'border_styles'      => "$this->main_css_element .faq_answer_image",
                        'border_styles_hover' => "$this->main_css_element .faq_answer_image:hover",
                    )
                ),
        ...
        $advanced_fields['box_shadow'] = array(
            ...
            'que_wrapper_box_shadow' => array(
                'css' => array(
                    'main'  => "$this->main_css_element .df_faq_item .faq_question_wrapper",
                    'hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover",
                ),
                'toggle_slug'   => 'design_question',
                'tab_slug'      => 'advanced',
            ),
            ...
            'que_img_box_shadow' => array(
                'css' => array(
                    'main'  => "$this->main_css_element .df_faq_item .faq_question_image",
                    'hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_question_image",
                ),
                'toggle_slug'   => 'design_que_img',
                'sub_toggle'    => 'close',
                'tab_slug'      => 'advanced',
            ...
            'active_que_img_box_shadow' => array(
                'css' => array(
                    'main'  => "$this->main_css_element .df_faq_item.active .faq_question_image",
                    'hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_question_image",
                ),
                'toggle_slug'   => 'design_que_img',
                'sub_toggle'    => 'open',
                'tab_slug'      => 'advanced',
            ...
            'que_icon_box_shadow' => array(
                'css' => array(
                    'main'  => "$this->main_css_element .df_faq_item .faq_icon",
                    'hover' => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_icon",
                ),
                'toggle_slug'   => 'design_faq_icon',
                'sub_toggle'    => 'close',
                'tab_slug'      => 'advanced',
            ...
            'active_que_icon_box_shadow' => array(
                'css' => array(
                    'main'  => "$this->main_css_element .df_faq_item.active .faq_icon",
                    'hover' => "$this->main_css_element .df_faq_item.active .faq_question_wrapper:hover .faq_icon",
                ),
                'toggle_slug'   => 'design_faq_icon',
                'sub_toggle'    => 'open',
                'tab_slug'      => 'advanced',
    ...
    public function get_transition_fields_css_props()
    {
        ...
        $que_wrapper = "$this->main_css_element .df_faq_item .faq_question_wrapper";
        $active_que_wrapper = "$this->main_css_element .df_faq_item.active .faq_question_wrapper";

        $faq_que_text   = "$this->main_css_element .df_faq_item .faq_question_title";

        $icon_wrapper   = "$this->main_css_element .df_faq_item .faq_icon";
        $active_icon_wrapper   = "$this->main_css_element .df_faq_item.active .faq_icon";
        $close_que_icon = "$this->main_css_element .df_faq_item .faq_icon .et-pb-icon";
        $open_que_icon  = "$this->main_css_element .df_faq_item.active .faq_icon .et-pb-icon";

        // $que_img_wrapper_bg = "$this->main_css_element .df_faq_item .faq_question_image";
        // $active_que_img_wrapper_bg = "$this->main_css_element .df_faq_item.active .faq_question_image";
        $que_img = "$this->main_css_element .df_faq_item .faq_question_image";
        $active_que_img = "$this->main_css_element .df_faq_item.active .faq_question_image";
        ...
        $fields['que_img_bg']         = array('background-color' => $que_img);
        $fields['active_que_img_bg']  = array('background-color' => $active_que_img);
        ...
        $fields = $this->df_fix_border_transition($fields, 'que_img_wrapper_border', $que_img);
        ...
        $fields = $this->df_fix_box_shadow_transition($fields, 'que_img_box_shadow', "$this->main_css_element .faq_question_image");
        $fields = $this->df_fix_box_shadow_transition($fields, 'active_que_img_box_shadow', "$this->main_css_element .df_faq_item.active .faq_question_image");
        $fields = $this->df_fix_box_shadow_transition($fields, 'ans_btn_box_shadow', "$this->main_css_element .faq_button a");
    ...
    public function get_custom_css_fields_config()
    {
        return array(
            ...
            'close_que_icon_css' => array(
                'label'    => esc_html__('Closed Question Icon', 'divi_flash'),
                'selector' => "$this->main_css_element .faq_question_wrapper .faq_icon .close_icon span.et-pb-icon",
            ),
            'open_que_icon_css' => array(
                'label'    => esc_html__('Opened Question Icon', 'divi_flash'),
                'selector' => "$this->main_css_element .faq_question_wrapper .faq_icon .open_icon span.et-pb-icon",
            ),
            'close_que_img_css' => array(
                'label'    => esc_html__('Closed Question Image', 'divi_flash'),
                'selector' => "$this->main_css_element .faq_question_wrapper .close_image img",
            ),
            'open_que_img_css' => array(
                'label'    => esc_html__('Opened Question Image', 'divi_flash'),
    ...
    public function additional_css_styles($render_slug)
    {
        ...
        $this->df_process_bg(
            array(
                ...
                'selector'    => "$this->main_css_element .df_faq_item .faq_question_wrapper",
                'hover'       => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover",
            )
        );
        $this->df_process_bg(
        ...
        $this->df_process_color(
            array(
                ...
                'selector'    => "$this->main_css_element .df_faq_item .faq_icon",
                'hover'       => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_icon"
            )
        );
        ...
        $this->df_process_color(
            array(
                ...
                'slug'        => 'que_img_bg',
                'type'        => 'background-color',
                'selector'    => "$this->main_css_element .df_faq_item .faq_question_image",
                'hover'       => "$this->main_css_element .df_faq_item .faq_question_wrapper:hover .faq_question_image",
            )
        );
        ...
        $this->df_process_color(
            array(
                ...
                'type'        => 'color',
                'selector'    => "$this->main_css_element .faq_question_wrapper .faq_icon .close_icon span.et-pb-icon, $this->main_css_element .faq_question_wrapper .faq_icon .open_icon span.et-pb-icon",
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .faq_icon .close_icon span.et-pb-icon, $this->main_css_element .faq_question_wrapper:hover .faq_icon .open_icon span.et-pb-icon",
                'important'   => false,
            )
        );
        ...
        $this->df_process_color(
            array(
                ...
                'type'        => 'color',
                'selector'    => "$this->main_css_element .faq_question_wrapper .faq_icon .open_icon span.et-pb-icon",
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .faq_icon .open_icon span.et-pb-icon",
                'important'   => true,
            )
        );
        ...
        $this->df_process_range(
            array(
                ...
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .close_image img"
            )
        );
        ...
        $this->df_process_range(
            array(
                ...
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .open_image img",
            )
        );
        ...
        $this->set_margin_padding_styles(
            array(
                ...
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .faq_question_title",
                'important'   => false
            )
        );
        ...
        $this->set_margin_padding_styles(
            array(
                ...
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .faq_icon",
                'important'   => false
            )
        );
        ...
        $this->set_margin_padding_styles(
            array(
                ...
                'hover'       => "$this->main_css_element .faq_question_wrapper:hover .faq_question_image",
                'important'   => false
            )
        );
        ...
        if ('on' === $this->props['faq_layout_grid']) {
            ET_Builder_Element::set_style($render_slug, array(
                'selector'    => "$this->main_css_element .df_faq_wrapper.grid_layout",
                'declaration' => "grid-auto-flow: column !important; grid-auto-columns: minmax(0, 1fr);"
            ));
            ...
            $this->df_process_range(
                array(
                    ...
                    'default'     => '20',
                    'type'        => 'gap',
                    'selector'    => "$this->main_css_element .df_faq_wrapper .column"
                )
            );
        }
        ...
        if ('plain' !== $this->props['faq_layout']) {
            ...
            ET_Builder_Element::set_style($render_slug, array(
                'selector'    => "$this->main_css_element .faq_question_wrapper",
                'declaration' => 'cursor: inherit !important;'
            ));
        }
    }
    ...
    public function df_render_schema()
    {
		...
		if('on' === $this->props['enable_schema'] && !empty($df_faq_schema_data) && is_array($df_faq_schema_data)){
			$schema = [
			...
			$script = sprintf('<script type="application/ld+json">%1$s</script>', wp_json_encode($schema));
		}
	    $df_faq_schema_data = [];
        return $script;
    }
    ...
    public function render($attrs, $content, $render_slug)
    {
        ...
        $data_settings = [
            ...
            'faq_layout_grid'          => isset($this->props['faq_layout_grid']) ? $this->props['faq_layout_grid'] : 'off',
            'faq_item_per_column'      => isset($this->props['faq_item_per_column']) ? $this->props['faq_item_per_column'] : 2,
            'faq_item_per_column_tablet'=> isset($this->props['faq_item_per_column_tablet']) ? $this->props['faq_item_per_column_tablet'] : $this->props['faq_item_per_column'],
            'faq_item_per_column_phone'=> isset($this->props['faq_item_per_column_phone']) ? $this->props['faq_item_per_column_phone'] : $this->props['faq_item_per_column_tablet']
        ];

        // Display frontend
        $grid_system_class = isset($this->props['faq_layout_grid']) &&  $this->props['faq_layout_grid'] === 'on' ? 'grid_layout': '';
        $output = sprintf(
            '<div class="df_faq_wrapper %4$s" data-settings=\'%3$s\'>%1$s</div>
            %2$s',
